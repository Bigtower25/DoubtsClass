...
START TRANSACTION;
USE `aplicacionesweb`;
INSERT INTO `aplicacionesweb`.`Pregunta` (`Titulo`, `Votos`, `Descripcion`, `Usuario_idUsuario`, `Hora`, `idPregunta`, `Fecha`) VALUES ('Que es una integral?', 0, 'Necesito ayuda con integrales.', 'asoler23', '00:00', 2, NULL);
INSERT INTO `aplicacionesweb`.`Pregunta` (`Titulo`, `Votos`, `Descripcion`, `Usuario_idUsuario`, `Hora`, `idPregunta`, `Fecha`) VALUES ('Que es una matriz?', 2, 'Pues no se lo que es una matriz', 'prueba', '00:00', 1, NULL);
INSERT INTO `aplicacionesweb`.`Pregunta` (`Titulo`, `Votos`, `Descripcion`, `Usuario_idUsuario`, `Hora`, `idPregunta`, `Fecha`) VALUES ('Como definir variables en JAVA', 5, 'Como defino variables en el lengiaje de programación java.', 'prueba', NULL, 3, NULL);
