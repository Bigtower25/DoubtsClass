...
START TRANSACTION;
USE `aplicacionesweb`;
INSERT INTO `aplicacionesweb`.`Usuario` (`idUsuario`, `Nombre`, `Apellido_1`, `Apellido_2`, `Edad`, `Password`, `Fecha_Registro`, `Localizacion`, `Email`, `Privilegio`, `Foto`) VALUES ('asoler23', 'Angel', 'Soler', 'Ruiz', 23, '123456', '2/07/2015', 'Madrid', 'angelsoler91@gmail.com', 0, NULL);
INSERT INTO `aplicacionesweb`.`Usuario` (`idUsuario`, `Nombre`, `Apellido_1`, `Apellido_2`, `Edad`, `Password`, `Fecha_Registro`, `Localizacion`, `Email`, `Privilegio`, `Foto`) VALUES ('admin', 'Toni', 'Torregrpsa', 'Povedano', 24, '1234', '1/07/2015', 'Madrid', 'dc.admin@gmail.com', 1, NULL);
INSERT INTO `aplicacionesweb`.`Usuario` (`idUsuario`, `Nombre`, `Apellido_1`, `Apellido_2`, `Edad`, `Password`, `Fecha_Registro`, `Localizacion`, `Email`, `Privilegio`, `Foto`) VALUES ('prueba', 'Marcos', 'Prueba', 'Prueba', 15, 'prueba', '2/07/2015', 'Barcelona', 'prueba.prueba@prueba.com', 0, NULL);
