...
START TRANSACTION;
USE `aplicacionesweb`;
INSERT INTO `aplicacionesweb`.`Pregunta` (`Titulo`, `Fecha`, `Votos`, `Descripcion`, `Usuario_idUsuario`, `Hora`, `idPregunta`) VALUES ('Que es una integral?', '2/07/2015', 0, 'Necesito ayuda con integrales.', 'asoler23', '00:00', 2);
INSERT INTO `aplicacionesweb`.`Pregunta` (`Titulo`, `Fecha`, `Votos`, `Descripcion`, `Usuario_idUsuario`, `Hora`, `idPregunta`) VALUES ('Que es una matriz?', '2/07/2015', 2, 'Pues no se lo que es una matriz', 'prueba', '00:00', 1);
