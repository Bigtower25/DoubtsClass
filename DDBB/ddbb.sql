...
START TRANSACTION;
USE `aplicacionesweb`;
INSERT INTO `aplicacionesweb`.`Usuario` (`idUsuario`, `Nombre`, `Apellido_1`, `Apellido_2`, `Edad`, `Password`, `Fecha_Registro`, `Localizacion`, `Email`, `Privilegio`, `Foto`, `Bio`) VALUES ('asoler23', 'Angel', 'Soler', 'Ruiz', 23, '123456', '2/07/2015', 'Madrid', 'angelsoler91@gmail.com', 0, NULL, NULL);
INSERT INTO `aplicacionesweb`.`Usuario` (`idUsuario`, `Nombre`, `Apellido_1`, `Apellido_2`, `Edad`, `Password`, `Fecha_Registro`, `Localizacion`, `Email`, `Privilegio`, `Foto`, `Bio`) VALUES ('admin', 'Toni', 'Torregrpsa', 'Povedano', 24, '1234', '1/07/2015', 'Madrid', 'dc.admin@gmail.com', 1, NULL, NULL);
INSERT INTO `aplicacionesweb`.`Usuario` (`idUsuario`, `Nombre`, `Apellido_1`, `Apellido_2`, `Edad`, `Password`, `Fecha_Registro`, `Localizacion`, `Email`, `Privilegio`, `Foto`, `Bio`) VALUES ('prueba', 'Marcos', 'Prueba', 'Prueba', 15, 'prueba', '2/07/2015', 'Barcelona', 'prueba.prueba@prueba.com', 0, NULL, NULL);
...
START TRANSACTION;
USE `aplicacionesweb`;
INSERT INTO `aplicacionesweb`.`Pregunta` (`Titulo`, `Fecha`, `Votos`, `Descripcion`, `Usuario_idUsuario`, `Hora`, `idPregunta`) VALUES ('¿Qué es una integral?', '2/07/2015', 0, 'Necesito ayuda con integrales.', 'asoler23', '00:00', 2);
INSERT INTO `aplicacionesweb`.`Pregunta` (`Titulo`, `Fecha`, `Votos`, `Descripcion`, `Usuario_idUsuario`, `Hora`, `idPregunta`) VALUES ('¿Qué es una matriz?', '2/07/2015', 2, 'Pues no se lo que es una matriz', 'prueba', '00:00', 1);
INSERT INTO `aplicacionesweb`.`Pregunta` (`Titulo`, `Fecha`, `Votos`, `Descripcion`, `Usuario_idUsuario`, `Hora`, `idPregunta`) VALUES ('Como definir variables en JAVA', '2/07/2015', 5, 'Como defino variables en el lengiaje de programación java.', 'prueba', NULL, 3);
...
START TRANSACTION;
USE `aplicacionesweb`;
INSERT INTO `aplicacionesweb`.`Respuesta` (`idRespuesta`, `idUsuario`, `Votos`, `Fecha`, `Descripcion`, `Pregunta_idPregunta`, `Hora`) VALUES (1, 'prueba', 1, '2/07/2015', 'Pues la solucion es...', 1, NULL);
